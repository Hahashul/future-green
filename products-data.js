/* ================================================================
   ...
   Generated: 14/6/2026, 1:28:24 am
   Products: 31
   ──────────────────────────────────────────────────────────────
   DO NOT edit this file manually — use the converter tool.
================================================================ */
...
const FINISH = {
  ...
  '3-in-1': { bg: 'linear-gradient(135deg,#F5C518,#F5F0E4,#DFF0FF)', bd: '#ccc', lbl: '3-in-1 Colour' },
};

const CATS = [
  { slug: 'all',          label: 'All Products',                  json: null,                               sub: 'Browse the complete Future Green LED range.', hero: 'resources/product-range-overview.png' },
  { slug: 'architectural',label: 'Architectural Lights',          json: ['Architectural Lights'],           sub: 'Elevation and façade lighting for building exteriors.', hero: 'resources/cat-architectural.jpeg' },
  { slug: 'indoor',       label: 'Indoor Lights',                 json: ['Indoor Lights'],                  sub: 'COB spotlights, slim panels, downlights and strip lighting.', hero: 'resources/cat-indoor.jpeg' },
  { slug: 'landscape',    label: 'Landscape Lights',              json: ['Landscape Lights'],               sub: 'Garden and landscape lighting for lawns and pathways.', hero: 'resources/cat-landscape.jpeg' },
  { slug: 'outdoor',      label: 'Outdoor Lights',                json: ['Outdoor Lights'],                 sub: 'Weatherproof outdoor LED lights for exteriors and security.', hero: 'resources/cat-outdoor.jpeg' },
  { slug: 'commercial',   label: 'Commercial & Industrial Lights',json: ['Commercial & Industrial Lights'], sub: 'Heavy-duty flood lights, street lights and panels.', hero: 'resources/cat-commercial.jpeg' },
  { slug: 'office',       label: 'Office Lights',                 json: ['Office Lights'],                  sub: 'Slim panels, downlights and COB spotlights for offices.', hero: 'resources/cat-office.jpeg' },
  { slug: 'stadium',      label: 'Stadium Lights',                json: ['Stadium Lights'],                 sub: 'High-power lights for stadiums and large outdoor venues.', hero: 'resources/cat-stadium.jpeg' },
];
...
const PRODUCTS = [

  {
    ...
    finishes:    ['WW', 'WH', 'NW'],
    shapes:      ['Round', 'Square'],
    features:    ['Wafer-thin profile fits shallow false ceilings', '3-in-1 colour switch (warm / natural / cool) on select models', 'Uniform glow with no visible hot spots'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WW', 'WH', 'NW'],
    shapes:      ['Round', 'Square'],
    features:    ['Durable PC body and diffuser, ideal for humid rooms', 'Smooth, uniform light with a wide spread', '3-in-1 colour option on select models'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WW', 'WH', 'NW'],
    shapes:      ['Round', 'Square'],
    features:    ['No cutout needed — fixes to any flat ceiling', '3-in-1 colour switch on select models', 'Slim surface body with even, comfortable output'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WW', 'WH', 'NW'],
    shapes:      ['Round', 'Square'],
    features:    ['Tough polycarbonate build', 'Soft, wide-angle diffusion', 'Quick surface installation, no recess'],
    warranty:    '2-year',
  },

  {
    ...
    shapes:      ['Round', 'Square'],
    features:    ['White centre + coloured rim, switched independently', 'Six halo finishes for instant ambience', 'Perfect for festivals, bedrooms and lounges'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WH', 'WW', 'R', 'B', 'G', 'P'],
    shapes:      ['Round', 'Square'],
    features:    ['White + coloured ring, controlled separately', 'Six halo colours to set any mood', 'Surface fit — mounts on any flat ceiling'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WH', 'WW', 'R', 'B', 'G', 'P'],
    shapes:      ['Round'],
    features:    ['Fits standard junction-box cut-outs', 'White + colour ring for daily and accent use', 'Deep design softens glare for relaxed rooms'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WW', 'WH', 'NW'],
    shapes:      ['Round', 'Square'],
    features:    ['No false ceiling needed', 'Borderless edge for a flush, modern look', 'Wide, even spread from a low-profile body'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WW', 'WH', 'NW'],
    shapes:      ['Round'],
    features:    ['Deep recess design cuts direct glare', 'Flicker-free, eye-friendly output', 'Compact cut-out with easy spring-clip fit'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WH', 'WW', 'R', 'B', 'G', 'P'],
    shapes:      ['Round'],
    features:    ['Rotatable / tiltable head to aim the beam', 'Sharp COB beam for accent and highlight', 'Concealed trim sits flush in the ceiling'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WH', 'WW', 'R', 'B', 'G', 'P'],
    shapes:      ['Round'],
    features:    ['Small footprint, strong focused output', 'Ideal for shelves, display and task accents', 'Cool-running, low-wattage COB'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WH', 'WW', 'R', 'B', 'G', 'P'],
    shapes:      ['Round', 'Square'],
    features:    ['Square trim with adjustable tilt head', 'Focused COB beam for accents and tasks', 'Anti-glare reflector for comfortable light'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WH', 'WW', 'R', 'B', 'G', 'P'],
    shapes:      ['Round'],
    features:    ['Tilting head with deep anti-glare housing', 'Finned heatsink for cool, stable performance', 'Punchy directional beam for tall spaces'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WH', 'WW'],
    shapes:      [],
    features:    ['DOB design means fewer failure points', 'Weather-resistant for outdoor mounting', '50-200W coverage for large open areas'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WH', 'WW'],
    shapes:      [],
    features:    ['Slim, low-profile die-cast housing', 'Broad, even outdoor coverage', 'Adjustable mounting bracket'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WH'],
    shapes:      [],
    features:    ['Wide road-optimised beam pattern', 'Tough, weather-ready housing', '24-100W for side lanes to main roads'],
    warranty:    '2-year',
  },

  {
    ...
    shapes:      ['Round'],
    features:    ['Rose-gold or gun-black mirror reflector', 'Die-cast body + finned heatsink, ~50,000 hrs'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WW', 'NW', 'WH', '3-in-1'],
    shapes:      ['Round'],
    features:    ['Deep anti-glare cup tucks the LED out of sight', 'Matte black or white die-cast body'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WW', 'NW', 'WH'],
    shapes:      [],
    features:    ['High-CRI COB with anti-glare reflector', 'Adjustable head — surface or track mount'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WW'],
    shapes:      [],
    features:    ['Twin up / down beams for a refined wall wash', 'Matte black body with warm gold interior'],
    warranty:    '2-year',
  },

  {
    ...
    shapes:      [],
    features:    ['Mirror-finish reflector in a clean cylinder', 'Crisp COB beam for accent and highlight'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WH'],
    shapes:      [],
    features:    ['100% solar — zero electricity bill, no wiring', 'Motion sensor + remote, smart dusk-dawn modes', 'IP65 weatherproof, LiFePO4 long-life battery'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WH', 'NW'],
    shapes:      [],
    features:    ['Finned die-cast body for cool, stable running', 'Adjustable bracket aims the beam where it\'s needed', 'High-output 100-200W for high-ceiling spaces'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WW', 'G', 'R', 'P', 'B'],
    shapes:      [],
    features:    ['Ground spike — no drilling or fixing', 'Adjustable head aims the beam', 'Warm white plus green, red, pink & blue'],
    warranty:    '2-year',
  },

  {
    ...
    shapes:      [],
    features:    ['Four-direction beam pattern', 'Weather-ready for exterior walls', 'Warm / white plus decorative colour options'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WW', 'WH', 'NW'],
    shapes:      [],
    features:    ['Two-direction up / down beams', 'Weather-ready exterior build', 'Clean, minimal modern form'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WW'],
    shapes:      [],
    features:    ['Twin up / down beam in a faceted body', 'Warm-white glow for inviting entrances', 'Weather-ready outdoor housing'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WW', 'WH', 'R', 'B', 'G', 'P', 'IB', 'YG'],
    shapes:      [],
    features:    ['Bends around edges, railings and signage', 'Eight finishes, from warm white to RGB tones', 'Long runs with a low power draw'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WW', 'WH', 'NW'],
    shapes:      [],
    features:    ['Self-adhesive and cut-to-length', 'Even line of light for coves and edges', 'Pairs with the Future Green SMPS driver'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    [],
    shapes:      [],
    features:    ['Regulated, stable output for long LED life', 'Short-circuit, overload & over-voltage protection', 'From 2A to 33A for small to large loads'],
    warranty:    '2-year',
  },

  {
    ...
    finishes:    ['WH', 'BK'],
    shapes:      [],
    features:    ['Surface-mounted single-circuit track', 'Pairs with the Aster Track Spotlight', 'Join 1 m and 2 m sections for any layout'],
    warranty:    '2-year',
  }
